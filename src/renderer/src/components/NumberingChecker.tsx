...
export default function NumberingChecker(): React.JSX.Element {
    ...
    const handleValidate = async (): Promise<void> => {
        ...
        if (!expectedCount || expectedCount < 1) {
            toast.error('Please enter expected question count (minimum 1)')
            return
        }
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto">
            ...
            <div className="bg-card border rounded-lg p-6 space-y-5">
                ...
                {/* Expected Count */}
                <div className="space-y-2">
                    <Label htmlFor="expected-count">Expected Question Count</Label>
                    <Input
                        id="expected-count"
                        type="number"
                        value={expectedCount}
                        onChange={(e) => setExpectedCount(e.target.value ? parseInt(e.target.value) : '')}
                        min={1}
                    ...
                    <p className="text-xs text-muted-foreground">
                        Enter the total number of questions expected in the files.
                    </p>
                </div>
                ...
                <div className="pt-4 border-t">
                    <Button
                        ...
                        disabled={isValidating || !questionsPath || !solutionsPath || !expectedCount}
